...
#import "CountryLabLocationTableViewController.h"
#import "LocationViewController.h"

@interface CountryLabLocationTableViewController ()

@end

@implementation CountryLabLocationTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if([segue.identifier isEqualToString:@"countryLabCellPressed"]){
        NSIndexPath *indexPath = [self.tableView indexPathForCell:sender];
        NSString *nameFromCountryList = self.countryLabs[indexPath.row];
        
        LocationViewController *lvc = [segue destinationViewController];
        lvc.countryLabName = nameFromCountryList;
        lvc.locationIndex = (int)indexPath.row;
    }
}
